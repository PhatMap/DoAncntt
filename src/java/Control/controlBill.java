...
public class controlBill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(currAccount!=null){
            ...
            String userCart = request.getParameter("userCart");
            String name = request.getParameter("name");
            String sdt = request.getParameter("sdt");
            String address = request.getParameter("address");
            DAO.CheckProductsCount(currAccount.getAcid().toString());
            DAO.AddNewBill(currAccount.getAcid().toString(),Integer.parseInt(total),name,sdt,address);
